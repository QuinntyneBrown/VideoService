...
const template = require("./video-item-embed.component.html");
const styles = require("./video-item-embed.component.scss");

export class VideoItemEmbedComponent extends HTMLElement {
    constructor() {
        super();
    ...
    private async _onDeleteClick(e:Event) {
        this.dispatchEvent(new VideoDelete(this.entity)); 
    }

    private _onEditClick() {
        this.dispatchEvent(new VideoEdit(this.entity));
    }
...
customElements.define(`ce-video-item-embed`,VideoItemEmbedComponent);
