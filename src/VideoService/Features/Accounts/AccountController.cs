...
using static VideoService.Features.Accounts.AddOrUpdateAccountCommand;
using static VideoService.Features.Accounts.GetAccountsQuery;
using static VideoService.Features.Accounts.GetAccountByIdQuery;
using static VideoService.Features.Accounts.RemoveAccountCommand;
