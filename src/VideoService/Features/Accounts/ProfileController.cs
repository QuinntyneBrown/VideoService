...
using static VideoService.Features.Accounts.AddOrUpdateProfileCommand;
using static VideoService.Features.Accounts.GetProfilesQuery;
using static VideoService.Features.Accounts.GetProfileByIdQuery;
using static VideoService.Features.Accounts.RemoveProfileCommand;
