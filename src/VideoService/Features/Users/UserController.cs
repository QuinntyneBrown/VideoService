...
using static VideoService.Features.Users.AddOrUpdateUserCommand;
using static VideoService.Features.Users.GetUsersQuery;
using static VideoService.Features.Users.GetUserByIdQuery;
using static VideoService.Features.Users.RemoveUserCommand;
using static VideoService.Features.Users.GetUserByUsernameQuery;

namespace VideoService.Features.Users
{
    [Authorize]
